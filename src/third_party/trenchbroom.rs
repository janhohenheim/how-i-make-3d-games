...
pub(super) fn plugin(app: &mut App) {
    app.add_plugins(TrenchBroomPlugins(TrenchBroomConfig::new("presentation")));
    app.add_systems(Startup, write_trenchbroom_config);
    app.register_type::<Worldspawn>();
    app.register_type::<LightPoint>();
    app.register_type::<LightDirectional>();
    app.register_type::<LightSpot>();
